...
Component {
    id: directLoadListElementDelegate

    Column {
        id: directLoadListElementDelegateColumn

        width: directLoadListView.width
        ...
        Rectangle{
            ...
            Rectangle{
                ...
                gradient: Gradient {
                    GradientStop {
                        position: 0.0; color: "#30bfcc"
                    }
                    GradientStop {
                        position: 0.5; color: "#30bfcc"
                    }
                    GradientStop {
